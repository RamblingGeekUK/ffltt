...
# Read the issue body
with open('test_issue.json', 'r') as f:
    data = json.load(f)
    body = data['body']
...
if socials_raw and socials_raw != "_No response_":
    try:
        ...
        print(f"PARSED CUSTOM SOCIALS: {custom_socials}")
...
# Save to file
with open('test_new_entry.json', 'w') as f:
    json.dump(new_entry, f, indent=2)

print("Successfully created test_new_entry.json")
